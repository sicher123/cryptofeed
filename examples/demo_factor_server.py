...
from cryptofeed.exchanges import HuobiR, HuobiDMR , HuobiSwapR , OKEx , Binance, BinanceFutures,OKCoin
from datetime import datetime
from cryptofeed.pairs import binance_pairs, binance_futures_pairs, bitmax_pairs , okcoin_pairs
