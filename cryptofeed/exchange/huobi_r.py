...
from cryptofeed.defines import KLINE , HUOBI_R
...
class HuobiR(RestFeed):
    id = HUOBI_R

    def __init__(self, pairs=None, channels=None, callbacks=None, config=None, **kwargs):
        super().__init__('https://api.huobi.pro/market/history/kline', pairs=pairs, channels=channels, config=config, callbacks=callbacks, **kwargs)
